(() => {
    ...
    const products = document.getElementsByClassName("js-add");
    for (const product of products) product.addEventListener("click", (function handleClick() {
        product.parentElement.classList.add("active");
    }));
    window["FLS"] = false;
    isWebp();
    menuInit();
